...
from Fitnes_bot.bot.buttons import main_page_button, male_female_btn, months_btn, week_days_btn
from Fitnes_bot.bot.db.models import User
from Fitnes_bot.bot.functions import beautiful_soup
from Fitnes_bot.bot.states import FitnesState
...
async def main_page_handler(message: Message, state: FSMContext, session: Session) -> None:
    if message.text == 'NewsPost 📄':
        ...
        await message.answer("Ramini olishga harakat qildim lekin htmlini yaxshi tushunomadim. Shuning uchun faqat Titleni oldim xolos")
